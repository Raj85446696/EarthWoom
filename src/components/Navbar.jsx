    ...
    <nav className="bg-[#3e2f26] text-[#f3ede2] shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <a href="#blog" className="hover:text-[#d9b382] transition">Our Blog</a>
            <a href="#products" className="hover:text-[#d9b382] transition">Our Product</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#3e2f26] space-y-2 px-4 pb-4">
          ...
          <a href="#blog" className="block py-2 hover:text-[#d9b382]">Our Blog</a>
          <a href="#products" className="block py-2 hover:text-[#d9b382]">Our Product</a>
